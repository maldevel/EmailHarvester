...
def search(keyword, domain, limit):
    ...
    url = 'https://www.google.com/search?num=100&start={counter}&hl=en&q=site%3Aplus.google.com+intext:"Works at"+-inurl:photos+-inurl:about+-inurl:posts+-inurl:plusones+{keyword}+%40{word}'
    app_emailharvester.init_search(url, keyword, domain, limit, 0, 100, 'Google+')
